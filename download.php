...
<h3>NatTable 2.0.2 (<a href="https://bugs.eclipse.org/bugs/buglist.cgi?product=NatTable&target_milestone=2.0.2&order=Last%20Changed">changelog</a>)</h3>

<p>Release artifacts can be obtained from the following p2 repository: <a href="http://download.eclipse.org/nattable/releases/2.0.2/repository/">http://download.eclipse.org/nattable/releases/2.0.2/repository/</a></p>
<p>A zipped p2 repository is also available here: <a href="/downloads/download.php?file=/nattable/releases/2.0.2/repository.zip">repository.zip</a></p>
